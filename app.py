...
def analyze_data(text):
    ...
    2. Rizikový Rating (0–100).
        Stupnica:       0–25 nízke riziko, farba textu zelená bold
                        26–50 stredné riziko, farba textu žltá bold
                        51–75 vysoké riziko, farba  textu červená bold
                        76–100 kritické riziko. farba textu červená a horiaca ikona bold
